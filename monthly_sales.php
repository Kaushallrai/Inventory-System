    ...
    <div class="container mx-auto px-4">
      <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="bg-blue-500 py-4 px-6 flex items-center justify-between">
          <h2 class="text-white font-semibold text-xl">Monthly Sales</h2>
        </div>
            ...
            <tbody class="text-gray-600 text-sm font-light border">
              <?php foreach ($sales as $sale): ?>
                <tr class="border border-gray-200 hover:bg-gray-100 font-medium">
                  <td class="py-3 px-6 text-center border"><?php echo count_id(); ?></td>
                  <td class="py-3 px-6 border"><?php echo remove_junk($sale['name']); ?></td>
                  <td class="py-3 px-6 text-center border"><?php echo (int) $sale['qty']; ?></td>
                  <td class="py-3 px-6 text-center border"><?php echo remove_junk($sale['total_saleing_price']); ?></td>
                  <td class="py-3 px-6 text-center border"><?php echo $sale['date']; ?></td>
                </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
