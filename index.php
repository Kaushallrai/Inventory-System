...
<body class="bg-gray-200">
    <div class="flex justify-center">
        ...
        <div class="max-w-[500px] rounded-3xl my-10 ml-[-5px] h-[650px] relative shadow-md">
            <span class="absolute text-white text-3xl font-medium right-6 top-5 hidden lg:block z-10">Inventerio</span>
            <span class="absolute text-white text-base font-medium px-6 bottom-6 hidden lg:block z-10">Embark on a
                journey of inventory mastery. Login to control, track, and optimize your stock, ensuring your business
                sails smoothly.</span>
