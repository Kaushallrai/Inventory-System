...
<body class="bg-gray-100" style="height: 100vh; overflow-y: auto;">
    <div x-data="{ modalAdd: false,modalEdit: false }">
        <div class="relative">
            <div class="ml-60 fixed z-50 right-0 left-0 top-0" :class="{ 'hidden': modalAdd}">
        ...
        <div class="ml-64 mt-20">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 ">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <!-- Modal-Add -->
                    <div x-show="modalAdd"
                        class="fixed z-10 inset-0 overflow-y-auto flex items-center justify-center"" aria-labelledby="
                        ...
                        <div x-show="modalAdd" x-transition:enter="ease-out duration-300"
                            ...
                            <div class="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                                <button @click="modalAdd = false" type="button"
                                        ...
                                        <form method="post" action="add_group.php">
                                            <div class="mb-4">
                                                <label for="group-name"
                                                    class="block text-gray-700 font-semibold mb-2">Group
                                                    Name</label>
